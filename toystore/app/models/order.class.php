...
Class Order extends Controller {
    ...
    public function validate($POST) {
        ...
        foreach ($POST as $key => $value) {
            ...
            if($key == "address1") {
                if(empty($value)) {
                    $this->errors[] = "Please enter your first address!";
                }
            }
            ...
            if($key == "mobile_phone") {
                if(empty($value)) {
                    $this->errors[] = "Please enter your mobile number!";
                }
            }
    ...
    public function save_order($POST,$ROWS,$user_url,$sessionid) {
        ...
        if(is_array($ROWS) && count($this->errors) == 0) {
            ...
            $query = "insert into orders (user_url,delivery_address,total,country,state,zip,tax,shipping,date,sessionid,mobile_phone,home_phone)
            values
    ...
    public function get_order_details($id) {
        ...
        $query = "select * from order_details where orderid = :id order by id desc limit 100";
