	...
	<!-- End of alert error -->
		<?php if(is_array($ROWS)): ?>
			...
			<div class="register-req">
				<p>Fill out your personal payment information</p>
			</div><!--/register-req-->
			...
			<form method="post">
				<div class="shopper-informations">
						...
						<div class="col-sm-8 clearfix">
							<div class="bill-to">
								...
								<div class="form-one">
									...
									<input name="postal_code" value="<?=$postal_code?>" class="form-control" type="text" placeholder="Zip / Postal Code *"><br>
					...
					<input type="submit" class="btn btn-default check_out pull-right" value="Continue >" name="">
			...
			<a href="<?=ROOT?>cart">
				<input type="button" class="btn btn-default return pull-left" value="< Back to cart" name="">
			</a>
		</div>
	</section> <!--/#cart_items-->
