        ...
        <?php elseif($type == "slider_images"): ?>
            ...
            <?php elseif($action == "add"): ?>
                ...
                <div class="form-group">
                    ...
                    <input id="header1_text" type="text" value="<?=(isset($POST['header1_text'])) ? $POST['header1_text'] : '';?>" class="form-control" name="header1_text" placeholder="" autofocus>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input id="link" type="text" value="<?=(isset($POST['link'])) ? $POST['link'] : '';?>" class="form-control" name="link" placeholder="eg: https://yourwebsite.com/your_product">
                </div>
                <div class="form-group">
