        ...
        <div class="content-panel">
            <table class="table table-striped table-advance table-hover">
                ...
                <div class="add_new add_edit_panel hide">
                    ...
                    <button type="button" class="btn btn-danger" onclick="show_add_new(event)" style="position: absolute; margin-top: 20px; bottom: 10px; left: 10px;">Close</button>
                    <button type="button" class="btn btn-primary" onclick="collect_data(event)" style="position: absolute; margin-top: 20px; bottom: 10px; right: 10px;">Save</button>
                </div>
                <!-- Add new product end -->
                ...
                <div class="edit_product add_edit_panel hide">
                    ...
                    <button type="button" class="btn btn-danger" onclick="show_edit_product(0,'',false)" style="position: absolute; margin-top: 20px; bottom: 10px; left: 10px;">Cancel</button>
                    <button type="button" class="btn btn-primary" onclick="collect_edit_data(event)" style="position: absolute; margin-top: 20px; bottom: 10px; right: 10px;">Save</button>
                </div>
                <!-- Edit product end -->
...
<script type="text/javascript">
    ...
    function show_edit_product(id,product,e) {
        ...
        if(e) {
            ...
            show_add_box.style.top = (e.clientY - 145) + "px";
    ...
    function collect_data(e) {
        ...
        if(image_input.files.length == 0) {
            alert("Please add a valid main image!");
            return;
        }
